        ...
        <div className=''>
          <div className=''>
            <div className="relative" >
              <img src={main} className="w-full h-[683px] object-cover ml-auto  bg-black bg-opacity-100 flex justify-center items-center opacity-30 z-10" alt="main" />
              <div className='absolute top-1/4 left-44'>
                ...
                <div>
                  <ul className='flex gap-4 text-sm mt-8 text-white'>
                    ...
                    <li>
                      <Link to="/Blogs" className='border-b-2 border-yellow-400'>Blogs</Link>
                    </li>
                  </ul>
                </div>
              </div>
