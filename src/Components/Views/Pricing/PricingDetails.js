...
const PricingDetails = () => {
  return (
    <div className='mt-12 container mx-auto'>
      ...
      <div className='text-justify w-4/6 md:px-12 text-slate-600 my-12'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi vero accusantium sunt sit aliquam ipsum molestias autem perferendis, incidunt cumque necessitatibus cum amet cupiditate, ut accusamus. Animi, quo. Laboriosam, laborum.</div>
    </div>
  );
}
