  ...
  return (
    <div className='w-[1200px] mx-auto'>
      <div className='grid grid-cols-2 gap-14'>
        <div className='text-right mt-24  text-slate-700'>
          ...
          <div className='grid grid-cols-8 mt-8 gap-4 group'>
            <div className='col-span-7'>
              ...
              <div className='details w-3/4 ml-auto leading-7 font-light'>
                Even the all-powerful Pointing has no control about <br /> the blind texts it is an almost unorthographic.
              </div>
            </div>
            <div className='text-right'>
              <div className='bg-neutral-900 rounded-full h-20 w-20 flex justify-center items-center group-hover:bg-yellow-500'>
        ...
        <div className='text-left'>
          <div className='prividing-banner'>
          </div>
        </div>
      </div>
